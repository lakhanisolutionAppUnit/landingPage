...
function _createClass(t, e, s) {
    return e && _defineProperties(t.prototype, e), s && _defineProperties(t, s),
    ...
    return (
        _createClass(s, [
                ...
                value: function () {
                    ...
                    this.prevBtn &&
                        this.prevBtn.addEventListener("click", function (t) {
                            t.preventDefault(), 0 < s.selectedIndex && s.validateForm() && (s.selectedIndex--, s.showTabSelectedTab());
                        }),
                        this.nextBtn &&
                        this.nextBtn.addEventListener("click", function (t) {
                            t.preventDefault(), s.selectedIndex < s.navItems.length - 1 && s.validateForm() && (s.selectedIndex++, s.showTabSelectedTab());
                        }),
                        this.firstBtn &&
                        this.firstBtn.addEventListener("click", function (t) {
                            t.preventDefault(), 0 !== s.selectedIndex && s.validateForm() && ((s.selectedIndex = 0), s.showTabSelectedTab());
                        }),
                        this.lastBtn &&
                        this.lastBtn.addEventListener("click", function (t) {
                            t.preventDefault(), s.selectedIndex !== s.navItems.length - 1 && s.validateForm() && ((s.selectedIndex = s.navItems.length - 1), s.showTabSelectedTab());
                        }),
                        this.navItems.forEach(function (t, e) {
                            t.addEventListener("click", function () {
                                (s.selectedIndex = e), s.validateForm() && s.showTabSelectedTab();
                            });
                        });
                },
            },
            {
                ...
                value: function () {
                    new bootstrap.Tab(this.navItems[this.selectedIndex]).show(), this.progressBar && (this.progressBar.style.width = (((this.selectedIndex + 1) / this.navItems.length) * 100).toString() + "%"), this.changeBtnStyle();
                },
            },
            {
                key: "changeBtnStyle",
                value: function () {
                    this.lastBtn.classList.remove("disabled"),
                        ...
                        0 === this.selectedIndex
                            ? (this.prevBtn.classList.add("disabled"), this.firstBtn.classList.add("disabled"))
                            : this.selectedIndex === this.navItems.length - 1 && (this.nextBtn.classList.add("disabled"), this.lastBtn.classList.add("disabled"));
                },
            },
            {
                key: "validateForm",
